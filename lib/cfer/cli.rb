...
module Cfer
  module Cli
    CFER_CLI = Cri::Command.define do
      ...
      flag nil, :pretty_print, 'Render JSON in a more human-friendly format'
    ...
    CFER_CLI.define_command do
      name 'converge'
      usage 'converge [OPTIONS] <stack-name>'
    ...
    CFER_CLI.define_command do
      name 'generate'
      usage 'generate [OPTIONS] <template.rb>'
